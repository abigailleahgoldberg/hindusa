...
export const metadata: Metadata = {
  title: 'Privacy Policy | Hindusa',
  description: 'Privacy Policy for Hindusa. Learn how we collect, use, and protect your personal information.',
};
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#F5EDE0', border: '1px solid #F0E6D6', borderRadius: '8px', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ lineHeight: 1.8 }}>
            Hindusa (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) operates https://hindusa.com. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>
        </div>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', lineHeight: 1.8 }}>
            <li style={{ marginBottom: '0.5rem' }}><strong>Vercel</strong> — website hosting and infrastructure (<a href="https://vercel.com/legal/privacy-policy" style={{ color: '#FF9933' }}>Privacy Policy</a>)</li>
            <li style={{ marginBottom: '0.5rem' }}><strong>Brevo (Sendinblue)</strong> — email marketing and newsletter management (<a href="https://www.brevo.com/legal/privacypolicy/" style={{ color: '#FF9933' }}>Privacy Policy</a>)</li>
            <li style={{ marginBottom: '0.5rem' }}><strong>Stripe</strong> — payment processing where applicable (<a href="https://stripe.com/privacy" style={{ color: '#FF9933' }}>Privacy Policy</a>)</li>
          </ul>
        </section>
